...
const float A1_inv[3][3] = {
 {1.077953, 0.032893, -0.006236}, // Row 1
  {0.032893, 1.100125, 0.010968}, // Row 2
  {-0.006236, 0.010968, 1.043112}   // Row 3
};

const float b1[3] = {-0.037572, -0.003061, -0.010262};

const float A2_inv[3][3] = {
  {1.052603, 0.030756, 0.135791}, // Row 1
  {0.030756, 1.201982, -0.032425}, // Row 2
  {-0.011297, -0.032425, 1.042631} // Row 3
};

const float b2[3] = {-0.054392, -0.095948, 0.135791};
