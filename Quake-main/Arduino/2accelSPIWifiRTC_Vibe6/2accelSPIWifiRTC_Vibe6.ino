...
RTC_PCF8523 rtc;   // or DS1307 if that’s what you’re using
File f;
char filename[40];   // bigger buffer for datetime filenames
...
const float A1_inv[3][3] = {
  {1.013371, 0.000213, 0.001822},
  {0.000213, 1.009436, -0.004087},
  {0.001822, -0.004087, 1.045903}
};

const float b1[3] = {0.041288, -0.073675, -0.132785};

const float A2_inv[3][3] = {
  {1.009473, -0.000612, -0.000388},
  {-0.000612, 1.008358, -0.001549},
  {-0.000388, -0.001549, 1.049304}
};

const float b2[3] = {-0.006801, -0.003082, -0.078358};
