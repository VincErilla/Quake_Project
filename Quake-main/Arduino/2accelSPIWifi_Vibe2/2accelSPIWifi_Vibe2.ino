...
const float A1_inv[3][3] = {
  {1.054258, -0.012149, -0.025876},
  {-0.012149, 1.068008, 0.013747},
  {-0.009235, 0.013747, 1.056348}
};

const float b1[3] = {0.010837, -0.058245, -0.064395};

const float A2_inv[3][3] = {
  {1.040097, -0.010650, -0.010564},
  {-0.010650, 1.048510, 0.013012},
  {-0.010564, 0.013012, 1.047616}
};

const float b2[3] = {0.028493, -0.028454, -0.040600};
